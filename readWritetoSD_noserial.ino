...
void loop() {
  ...
  if (State > 0)
  {
    ...
    if (currentTime - prevTime > interval)   {
      ...
      myIMU.ax = (float)myIMU.accelCount[0] * myIMU.aRes - myIMU.accelBias[0]; //*myIMU.aRes;
      myIMU.ay = (float)myIMU.accelCount[1] * myIMU.aRes - myIMU.accelBias[1]; //*myIMU.aRes;
      myIMU.az = (float)myIMU.accelCount[2] * myIMU.aRes - myIMU.accelBias[2]; //*myIMU.aRes;
